...
('G10005', '儿童学习护眼平板', 'https://example.com/agent-group/goods/G10005.png', 1899.00, '10.4 英寸护眼屏，家长管控，学习内容分级，适合儿童学习', '7 天无理由退货，1 年质保；学习内容权益按激活规则处理', '适合家长为儿童学习、网课和阅读购买，价格低且管控能力完整', '大学生论文写作、专业绘图和大型应用用户', 1, 50),
