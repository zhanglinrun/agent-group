...
import com.linrun.reactor.domain.agent.runtime.tool.factory.AgentToolCollectionFactory;
import com.linrun.reactor.domain.agent.runtime.tool.mcp.runtime.McpToolExecutor;
import com.linrun.reactor.domain.agent.runtime.tool.skill.DefaultSkillRegistry;
import com.linrun.reactor.domain.agent.runtime.tool.skill.SkillMarkdownParser;
import com.linrun.reactor.domain.agent.runtime.tool.skill.SkillPathGuard;
import com.linrun.reactor.domain.agent.runtime.tool.skill.SkillRuntimeOptions;
import com.linrun.reactor.domain.agent.runtime.tool.skill.SkillScriptDiscoverer;
...
public class AgentToolCollectionFactoryTest {
    ...
    private static final class SilentPrinter implements Printer {
        ...
        @Override
        public void updateAgentType(com.linrun.reactor.domain.agent.runtime.enums.AgentType agentType) {
        }
    }
}
