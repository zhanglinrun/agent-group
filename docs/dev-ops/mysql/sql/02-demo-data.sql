...
('G10005', '深度任务额度包', '', 99.90, 9990.00, 'QUOTA_PACKAGE', '包含 9990 点额度，适合复杂主题拆解、多轮调研和报告生成', '虚拟额度到账后不支持无理由退款；未使用额度退款时会回滚到账额度', '适合复杂项目调研、方案选型和技术路线规划', '只需要单轮短问答的用户', 1, 50),
...
('A10005', 'G10005', 84.90, 5, '深度任务额度包拼团', 'D10001', 0, 2, 5, 1440, 1, date_sub(now(), interval 1 day), date_add(now(), interval 10 day), null, null, 1),
...
('DOC10001', '额度包说明', '额度包资料', 'v1', 'DEMO_DATA', '演示数据脚本', 'ENABLED', 1),
('DOC10002', '长文档工作流说明', '文档工作流', 'v1', 'DEMO_DATA', '演示数据脚本', 'ENABLED', 1),
('DOC10003', '资料整理边界', '安全边界', 'v1', 'DEMO_DATA', '演示数据脚本', 'ENABLED', 1),
('DOC10004', 'Agent 评测场景说明', '评测样例', 'v1', 'DEMO_DATA', '演示数据脚本', 'ENABLED', 1),
('DOC10005', 'Agent 任务说明', 'Agent 任务规则', 'v1', 'DEMO_DATA', '演示数据脚本', 'ENABLED', 1),
('DOC10006', '数据分析规则', '数据分析规则', 'v1', 'DEMO_DATA', '演示数据脚本', 'ENABLED', 1),
('DOC10007', '任务场景补充说明', 'Agent 任务规则', 'v1', 'DEMO_DATA', '演示数据脚本', 'ENABLED', 1),
('DOC10008', 'Agent 回答边界说明', '安全边界', 'v1', 'DEMO_DATA', '演示数据脚本', 'ENABLED', 1)
on duplicate key update
...
('KF10004', 'DOC10001', 'G10002', '额度包资料', 'v1', '长文档额度包包含 4990 点额度，适合上传资料、生成摘要、提纲、执行清单和结构化报告。', 4, 'ENABLED', 1),
('KF10005', 'DOC10002', 'G10002', '文档工作流', 'v1', '整理长文档时需要分别提取背景、目标、约束、关键证据、风险和下一步行动。', 5, 'ENABLED', 1),
('KF10006', 'DOC10004', 'G10001', '评测样例', 'v1', 'Agent 回答需要同时说明任务目标、输入资料、生成结果和依据来源。', 6, 'ENABLED', 1),
('KF10007', 'DOC10004', 'G10001', '评测样例', 'v1', '多轮追问 PPT、流程图或文档时，应延续上一轮文件和任务上下文，保持标题、术语和结构一致。', 7, 'ENABLED', 1),
('KF10008', 'DOC10004', 'G10004', '评测样例', 'v1', '图片转图表场景需要先说明识别到的元素，再生成可编辑草稿；不能承诺严格 1:1 商业复刻。', 8, 'ENABLED', 1),
('KF10009', 'DOC10002', 'G10001', '文档工作流', 'v1', '整理资料时应按主题、代表方案、关键指标、限制条件和后续动作进行分组。', 9, 'ENABLED', 1),
('KF10010', 'DOC10003', 'G10001', '安全边界', 'v1', '如果原始资料或关键数据缺失，回答需要明确缺少的资料和后续核验步骤。', 10, 'ENABLED', 1),
...
('KF10016', 'DOC10006', 'G10001', '数据分析规则', 'v1', '数据问答工作区默认围绕项目数据、业务指标、实验结果和资料记录进行分析。', 16, 'ENABLED', 1),
...
('KF10022', 'DOC10003', 'G10001', '安全边界', 'v1', '回答结论时应区分原文内容、数据证据和模型总结，不要把二次总结写成原文引用。', 22, 'ENABLED', 1),
...
('KF10025', 'DOC10007', 'G10003', 'Agent 任务规则', 'v1', '批量生成项目汇报、方案评审或产品演示材料时，应先形成结构大纲，再生成页面内容。', 25, 'ENABLED', 1),
('KF10026', 'DOC10007', 'G10004', 'Agent 任务规则', 'v1', '图片、流程图和架构图重建需要先识别元素、关系和层级，再输出可编辑草稿。', 26, 'ENABLED', 1),
('KF10027', 'DOC10008', 'G10001', '安全边界', 'v1', 'Agent 可以生成草稿、提纲和可编辑结构，但不能保证外部资料结论真实、结果正确或资料已实际下载。', 27, 'ENABLED', 1),
('KF10028', 'DOC10008', 'G10001', '安全边界', 'v1', '如果没有检索到原始资料、数据表格或用户上传资料，回答必须说明依据不足。', 28, 'ENABLED', 1)
on duplicate key update
