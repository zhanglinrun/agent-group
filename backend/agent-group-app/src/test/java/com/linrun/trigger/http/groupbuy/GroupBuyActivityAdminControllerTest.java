...
import com.linrun.domain.groupbuy.service.GroupBuyActivityAdminService;
...
class GroupBuyActivityAdminControllerTest {
    ...
    void shouldListCreateToggleStockAndDeleteActivity() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/gbm/admin/goods-options"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.code").value("0000"))
                .andExpect(jsonPath("$.data[0].goodsId").value("G10001"));

        mockMvc.perform(get("/api/v1/gbm/admin/discount-options"))
                .andExpect(status().isOk())
        ...
        mockMvc.perform(post("/api/v1/gbm/admin/activities").contentType("application/json").content(body))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.code").value("0000"))
