 ...
 * &lt;think/&gt; 标签解析器�?
 *
 * 无状态工具类，将 LLM 流式输出的文�?chunk 拆分为思考内容和正常文本�?
 * 支持�?chunk 的标签状态追踪（通过 inThink 参数）�?
 *
 * @author bigchui
 */
public final class ThinkTagParser {
    ...
    public static String stripThinkTags(String input) {
        ...
        // 通用正则：匹�?<think...>...</think...>（兼容空格、属性、自闭合等变体）
     ...
     * @param inThink 上一�?chunk 结束时的 think 标签内状�?
     * @return 解析结果，包含拆分后的内容段和更新后�?inThink 状�?
     */
