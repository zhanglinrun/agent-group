...
import com.linrun.infrastructure.adapter.repository.LocalGuideConversationRepository;
...
class AgentGuideStreamHandlerTest {

    @Test
    void shouldBuildGuideEventsWithProductAndReferences() {
        AgentGuideStreamHandler service = streamService(new FakeGuideDataRepository());
    ...
    void shouldReturnErrorWhenRepositoryFails() {
        AgentGuideStreamHandler service = streamService(new FailingGuideDataRepository());
        GuideStreamRequest request = new GuideStreamRequest();
    ...
    void shouldUseConversationContextAndImageInputForFollowUp() {
        ...
        AgentGuideStreamHandler service = streamService(repository);
    ...
    void shouldQueryOrderStatusForOrderIntent() {
        AgentGuideStreamHandler service = streamService(new FakeGuideDataRepository(), new FakeTradeOrderRepository());
        GuideStreamRequest request = new GuideStreamRequest();
    ...
    private AgentGuideStreamHandler streamService(GuideDataRepository guideDataRepository) {
    ...
    private AgentGuideStreamHandler streamService(GuideDataRepository guideDataRepository,
        ...
        return new AgentGuideStreamHandler(
