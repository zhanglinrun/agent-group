...
import com.linrun.reactor.domain.agent.runtime.agent.BaseAgent;
...
import com.linrun.reactor.domain.agent.runtime.artifact.ToolArtifactSource;
import com.linrun.reactor.domain.agent.runtime.dto.File;
import com.linrun.reactor.domain.agent.runtime.dto.Message;
import com.linrun.reactor.domain.agent.runtime.dto.SubTaskExecutionResult;
import com.linrun.reactor.domain.agent.runtime.dto.tool.ToolCall;
import com.linrun.reactor.domain.agent.runtime.enums.AgentType;
import com.linrun.reactor.domain.agent.runtime.enums.AgentState;
import com.linrun.reactor.domain.agent.runtime.llm.LLM;
...
import com.linrun.reactor.domain.agent.runtime.tool.BaseTool;
...
import com.linrun.reactor.domain.agent.service.execute.planexecute.step.Step2PlanExecuteNode;
...
public class PlanSolveExecutionLedgerIntegrationTest {
    ...
    public void shouldReplayPlanningToolAsPlanAndTaskFrames() {
        ...
        Map<String, Long> toolIds = ledger.recorder.createToolInvocations(
                com.linrun.reactor.domain.agent.ledger.model.ToolInvocationBatchStartRecord.builder()
                        .runId(runId)
                        .requestId(context.getRequestId())
                        .llmInvocationId(llmInvocationId)
                        .agentName("planning")
                        .stepNo(1)
                        .items(List.of(com.linrun.reactor.domain.agent.ledger.model.ToolInvocationBatchStartRecord.Item.builder()
        ...
        ledger.recorder.finishToolInvocation(com.linrun.reactor.domain.agent.ledger.model.ToolInvocationFinishRecord.builder()
    ...
    public void shouldPersistPlanningStructuredOutputAndReplayOrdinaryReplanLifecycle() {
        ...
        Map<String, Long> toolIds = ledger.recorder.createToolInvocations(
                com.linrun.reactor.domain.agent.ledger.model.ToolInvocationBatchStartRecord.builder()
                        ...
                        .stepNo(1)
                        .items(List.of(
                                com.linrun.reactor.domain.agent.ledger.model.ToolInvocationBatchStartRecord.Item.builder()
    ...
    private AgentContext newPlanningAgentContext(String requestId,
                                                 String sessionId,
                                                 com.linrun.reactor.domain.agent.ledger.AgentExecutionRecorder recorder,
                                                 String closeUpdate) {
        ReactorConfig reactorConfig = new ReactorConfig();
