...
public class AgentScriptRunnerToolRuntime {
    ...
    public AgentScriptRunnerToolRuntime(AgentScriptRunnerPort scriptRunnerPort) {
        this.scriptRunnerPort = scriptRunnerPort;
    }

    public static AgentToolDefinition definition() {
        return AgentToolDefinition.builder(AgentToolOutputNames.SCRIPT_RUNNER)
    ...
    public AgentToolStructuredOutput call(AgentToolCallCommand command) {
        ...
        AgentScriptRunnerPort.AgentScriptRunRequest request = validatedRequest(arguments);
        AgentScriptRunnerPort.AgentScriptRunResult result = scriptRunnerPort.run(request);
        if (result == null) {
        ...
        return AgentToolStructuredOutput.builder(AgentToolOutputNames.SCRIPT_RUNNER)
    ...
    private AgentScriptRunnerPort.AgentScriptRunRequest validatedRequest(Map<String, Object> arguments) {
        String runtime = validateRuntime(defaultText(arguments.get("runtime"), "python"));
        return new AgentScriptRunnerPort.AgentScriptRunRequest(
