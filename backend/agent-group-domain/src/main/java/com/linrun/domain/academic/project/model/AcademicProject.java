...
public class AcademicProject {
    ...
    private final List<AcademicProjectFile> files = new ArrayList<>();
    private final List<AcademicProjectPatch> patches = new ArrayList<>();
    ...
    public List<AcademicProjectFile> getFiles() {
        return files;
    }

    public List<AcademicProjectPatch> getPatches() {
        return patches;
    }
}
