...
class GuideIntentRecognitionServiceTest {
    ...
    void shouldExtractStructuredOrderAndGoodsEntities() {
        GuideIntent intent = new GuideIntentRecognitionService()
                .recognize("帮我查一下订单 O10001 的退款状态，额度包是 G10002");
