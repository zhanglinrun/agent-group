...
public class AgentMcpServerDescriptor {
    ...
    private AgentMcpServerDescriptor(Builder builder) {
    ...
    public AgentMcpServerDescriptor withEnabled(boolean enabled) {
    ...
    public static final class Builder {
        ...
        public AgentMcpServerDescriptor build() {
            return new AgentMcpServerDescriptor(this);
        }
    }
}
