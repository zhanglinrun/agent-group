...
public class AgentWorkspace {
    ...
    private final List<AgentWorkspaceFile> files = new ArrayList<>();
    private final List<AgentWorkspacePatch> patches = new ArrayList<>();
    ...
    public List<AgentWorkspaceFile> getFiles() {
        return files;
    }

    public List<AgentWorkspacePatch> getPatches() {
        return patches;
    }
}
