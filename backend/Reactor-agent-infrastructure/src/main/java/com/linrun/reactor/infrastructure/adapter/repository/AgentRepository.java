...
import com.linrun.reactor.domain.agent.model.valobj.*;
import com.linrun.reactor.infrastructure.dao.*;
import com.linrun.reactor.infrastructure.dao.po.*;

import java.util.*;
import java.util.stream.Collectors;

import static com.linrun.reactor.domain.agent.model.valobj.enums.AiAgentEnumVO.*;
