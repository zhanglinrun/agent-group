 ...
 */
public class AgentTradeDiagnosisToolRuntime {
    ...
    public AgentTradeDiagnosisToolRuntime(TradeConsistencyCheckService consistencyCheckService) {
        this.consistencyCheckService = consistencyCheckService;
    }

    public static AgentToolDefinition diagnoseDefinition() {
        return AgentToolDefinition.builder(AgentToolOutputNames.TRADE_DIAGNOSIS)
    ...
    public static AgentToolDefinition listDefinition() {
        return AgentToolDefinition.builder(AgentToolOutputNames.TRADE_ORDER_LIST)
    ...
    public AgentToolStructuredOutput diagnose(AgentToolCallCommand command) {
        ensureConfigured();
        ...
        return AgentToolStructuredOutput.builder(AgentToolOutputNames.TRADE_DIAGNOSIS)
                .title("订单诊断：" + orderId)
    ...
    public AgentToolStructuredOutput list(AgentToolCallCommand command) {
        ensureConfigured();
        Map<String, Object> arguments = command == null ? Map.of() : command.getArguments();
        ...
        return AgentToolStructuredOutput.builder(AgentToolOutputNames.TRADE_ORDER_LIST)
    ...
    private String requireCurrentUser(AgentToolCallCommand command) {
