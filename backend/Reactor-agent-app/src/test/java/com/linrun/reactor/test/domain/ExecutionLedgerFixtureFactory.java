...
import com.linrun.reactor.domain.agent.ledger.IExecutionLedgerWriteRepository;
...
import com.linrun.reactor.domain.agent.ledger.entity.DialogueRun;
import com.linrun.reactor.domain.agent.ledger.entity.LlmInvocation;
...
import com.linrun.reactor.domain.agent.ledger.impl.AgentExecutionRecorderImpl;
...
import com.linrun.reactor.infrastructure.adapter.repository.ExecutionLedgerWriteRepository;
...
public final class ExecutionLedgerFixtureFactory {
    ...
    static Long activateRun(AgentContext context,
                            ...
                            String entryAgent,
                            String visitorId) {
        Long runId = recorder.createRun(com.linrun.reactor.domain.agent.ledger.model.DialogueRunStartRecord.builder()
