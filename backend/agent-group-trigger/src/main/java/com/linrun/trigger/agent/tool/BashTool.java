...
public class BashTool {
    ...
    private static String buildDynamicDescription() {
        ...
        String osNotes = isWindows
                ? "Windows 环境下优先使用 type、dir、copy、del、move、findstr 等命令。"
                : "Unix/Linux/Mac 环境下可以使用 ls、cat、grep、find、touch、mkdir、rm 等命令。";
    ...
    public String executeShellCommand(
            ...
            @ToolParam(description = "超时时间，单位毫秒，默认 120000", required = false) Long timeoutMs) { // @formatter:on
