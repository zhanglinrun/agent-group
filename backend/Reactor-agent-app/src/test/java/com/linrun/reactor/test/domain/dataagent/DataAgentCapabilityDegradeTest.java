package com.linrun.reactor.test.domain.dataagent;
...
import com.linrun.reactor.domain.agent.reactor.config.data.EsConfig;
import com.linrun.reactor.domain.agent.reactor.config.data.QdrantConfig;
import com.linrun.reactor.domain.agent.reactor.service.ChatModelInfoService;
import com.linrun.reactor.domain.agent.reactor.service.ColumnValueSyncService;
import com.linrun.reactor.domain.agent.reactor.service.EmbeddingService;
import com.linrun.reactor.domain.agent.reactor.service.QdrantService;
import com.linrun.reactor.infrastructure.adapter.port.OkHttpRemoteHttpAdapter;
import com.linrun.reactor.infrastructure.adapter.port.OkHttpRemoteStreamAdapter;
import com.linrun.reactor.infrastructure.adapter.port.ReactorToolFileArtifactAdapter;
...
public class DataAgentCapabilityDegradeTest {
    ...
    public void shouldInjectCaseSeamIntoDataAgentController() {
        ...
        Assert.assertFalse(fieldTypes.contains("com.linrun.reactor.domain.agent.reactor.service.DataAgentService"));
    }
    ...
    public void shouldInjectStableDomainSeamIntoDataAgentApplicationService() {
        ...
        Assert.assertTrue(fieldTypes.contains("com.linrun.reactor.domain.agent.rag.DataAgentQueryService"));
        Assert.assertFalse(fieldTypes.contains("com.linrun.reactor.domain.agent.reactor.service.DataAgentService"));
        Assert.assertFalse(fieldTypes.contains("com.linrun.reactor.domain.agent.reactor.service.Nl2SqlService"));
        Assert.assertFalse(fieldTypes.contains("com.linrun.reactor.domain.agent.reactor.service.ChatModelInfoService"));
        Assert.assertFalse(fieldTypes.contains("com.linrun.reactor.domain.agent.rag.SchemaRecallService"));
    }
