...
import com.linrun.reactor.domain.agent.runtime.handler.ReactAgentResponseHandler;
...
public class ReactExecutionLedgerIntegrationTest {
    ...
    public void shouldKeepRealtimeAndHistoryPlanThoughtContractAligned() {
        ...
        ReactAgentResponseHandler handler = new ReactAgentResponseHandler(
                new com.linrun.reactor.domain.agent.ledger.replay.ReplayProjector(
                        new com.linrun.reactor.domain.agent.ledger.replay.projector.ToolInvocationProjectorRegistry(
                                List.of(),
                                new com.linrun.reactor.domain.agent.ledger.replay.projector.impl.DefaultToolInvocationProjector()
                        )
                )
        );
