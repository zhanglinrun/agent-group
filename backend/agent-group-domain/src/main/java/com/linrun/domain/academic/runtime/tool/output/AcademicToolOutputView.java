...
public class AcademicToolOutputView {
    ...
    private final List<AcademicArtifact> artifactRefs;

    private AcademicToolOutputView(Builder builder) {
    ...
    public List<AcademicArtifact> getArtifactRefs() {
        return artifactRefs;
    }
    ...
    public static final class Builder {
        ...
        private List<AcademicToolFileRef> fileRefs = List.of();
        private List<AcademicArtifact> artifactRefs = List.of();
        ...
        public Builder artifactRefs(List<AcademicArtifact> artifactRefs) {
            this.artifactRefs = artifactRefs == null ? List.of() : List.copyOf(artifactRefs);
            return this;
        }

        public AcademicToolOutputView build() {
            return new AcademicToolOutputView(this);
        }
    }
}
