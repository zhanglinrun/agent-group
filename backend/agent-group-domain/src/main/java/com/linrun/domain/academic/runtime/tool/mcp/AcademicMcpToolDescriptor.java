...
import com.linrun.domain.academic.runtime.tool.AcademicToolSchemaNormalizer;
...
public class AcademicMcpToolDescriptor {
    ...
    private AcademicMcpToolDescriptor(Builder builder) {
    ...
    public AcademicToolDefinition toToolDefinition() {
        return AcademicToolDefinition.builder(qualifiedName())
    ...
    public static final class Builder {
        ...
        public AcademicMcpToolDescriptor build() {
            return new AcademicMcpToolDescriptor(this);
        }
    }
}
