...
public class AgentToolDefinition {
    ...
    private AgentToolDefinition(Builder builder) {
    ...
    public static AgentToolDefinition fromMcpDefinition(Map<String, Object> definition,
                                                           String category,
                                                           String source) {
    ...
    private static List<String> requiredArguments(List<String> configuredRequired,
        ...
        return AgentToolSchemaNormalizer.requiredArguments(inputSchema);
    }
    ...
    public static final class Builder {
        ...
        public AgentToolDefinition build() {
            return new AgentToolDefinition(this);
        }
    }
}
