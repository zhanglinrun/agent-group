...
import com.linrun.domain.agent.knowledge.service.KnowledgeVectorMaintenanceService;
import com.linrun.types.exception.AppException;
import org.springframework.stereotype.Service;

@Service
public class KnowledgeVectorOpsHandler {

    private final KnowledgeVectorMaintenanceService knowledgeVectorMaintenanceService;

    public KnowledgeVectorOpsHandler(KnowledgeVectorMaintenanceService knowledgeVectorMaintenanceService) {
