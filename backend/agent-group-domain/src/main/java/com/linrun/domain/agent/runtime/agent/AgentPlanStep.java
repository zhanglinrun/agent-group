...
public class AgentPlanStep {
    ...
    private AgentPlanStep(Builder builder) {
    ...
    public boolean isCompleted() {
        return AgentPlanLifecycleService.STATUS_COMPLETED.equals(status);
    }
    ...
    private static String normalizeStatus(String status) {
        return StringUtils.hasText(status) ? status.trim() : AgentPlanLifecycleService.STATUS_NOT_STARTED;
    }
    ...
    public static final class Builder {
        ...
        private int order = 1;
        private String status = AgentPlanLifecycleService.STATUS_NOT_STARTED;
        private String note = "";
        private String assignedAgent = "";
        ...
        public AgentPlanStep build() {
            return new AgentPlanStep(this);
        }
    }
}
