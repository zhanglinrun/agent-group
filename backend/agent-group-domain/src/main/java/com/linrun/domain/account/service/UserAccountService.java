...
public class UserAccountService {
    ...
    public LoginResponse register(RegisterRequest request) {
        ...
        user.setPasswordSalt(randomToken());
        user.setPasswordHash(hashPassword(request.getPassword(), user.getPasswordSalt()));
    ...
    public LoginResponse login(LoginRequest request) {
        ...
        if (!hashPassword(request.getPassword(), user.getPasswordSalt()).equals(user.getPasswordHash())) {
