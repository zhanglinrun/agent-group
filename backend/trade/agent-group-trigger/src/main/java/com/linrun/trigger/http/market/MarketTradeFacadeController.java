...
public class MarketTradeFacadeController {
    ...
    @PostMapping("/api/v1/market/trade/lock_market_pay_order")
    ...
    @PostMapping("/api/v1/market/trade/settlement_market_pay_order")
    ...
    @PostMapping("/api/v1/market/trade/refund_market_pay_order")
    ...
    @PostMapping("/api/v1/market/index/query_group_buy_market_config")
