...
class AcademicAgentExecutorSupportTest {
    ...
    void shouldMapRejectedSupplyToBusyException() {
        ...
        CompletableFuture<String> future = AcademicAgentExecutorSupport.supplyAsync(
                rejected, "工具并发", () -> "ok");

        ExecutionException exception = assertThrows(ExecutionException.class, future::get);
        AppException appException = assertInstanceOf(AppException.class, exception.getCause());
        assertEquals(AcademicAgentExecutorSupport.BUSY_CODE, appException.getCode());
    }
    ...
    void shouldMapRejectedExecuteToBusyException() {
        ...
        AppException exception = assertThrows(AppException.class,
                () -> AcademicAgentExecutorSupport.execute(rejected, "回放投影", () -> {
                }));
