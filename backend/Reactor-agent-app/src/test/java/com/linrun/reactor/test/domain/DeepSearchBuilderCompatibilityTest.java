...
import com.linrun.reactor.domain.agent.runtime.dto.DeepSearchrResponse;
import com.linrun.reactor.domain.agent.runtime.tool.common.DeepSearchStructuredResultBuilder;
...
public class DeepSearchBuilderCompatibilityTest {
    ...
    private static final class DeepSearchCompatibilityClassLoader extends URLClassLoader {
        ...
        private static final Set<String> BLOCKED_CLASS_NAMES = new LinkedHashSet<>(List.of(
                "com.linrun.reactor.domain.agent.ledger.model.tooloutput.DeepSearchStage$DeepSearchStageBuilder",
                "com.linrun.reactor.domain.agent.ledger.model.tooloutput.DeepSearchToolOutput$DeepSearchToolOutputBuilder",
                "com.linrun.reactor.domain.agent.ledger.model.tooloutput.DeepSearchQueryResult$DeepSearchQueryResultBuilder",
                "com.linrun.reactor.domain.agent.ledger.model.tooloutput.DeepSearchDoc$DeepSearchDocBuilder"
        ));

        private static final List<String> CHILD_FIRST_PREFIXES = List.of(
                "com.linrun.reactor.domain.agent.runtime.tool.common.DeepSearchStructuredResultBuilder",
                "com.linrun.reactor.domain.agent.runtime.dto.DeepSearchrResponse",
                "com.linrun.reactor.domain.agent.ledger.model.tooloutput.DeepSearch"
        );
