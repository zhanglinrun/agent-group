...
import com.linrun.reactor.infrastructure.dataquery.jdbc.connection.ConnectionWrapper;
import com.linrun.reactor.infrastructure.dataquery.jdbc.connection.JdbcConnectionFactory;
import com.linrun.reactor.domain.agent.reactor.data.provider.DataMetaProvider;

import java.sql.*;
import java.util.ArrayList;
import java.util.List;

import static com.linrun.reactor.infrastructure.dataquery.jdbc.catalog.AbstractJdbcCatalog.typeConvert;
