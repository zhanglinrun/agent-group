...
public final class AgentToolOutputNames {
    ...
    public static final String TRADE_DIAGNOSIS = "trade_diagnosis";
    public static final String TRADE_ORDER_LIST = "trade_order_list";
