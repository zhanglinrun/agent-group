package com.linrun.reactor.domain.agent.runtime.tool.factory;

import lombok.RequiredArgsConstructor;
import lombok.extern.slf4j.Slf4j;
import org.springframework.stereotype.Component;
import com.linrun.reactor.domain.agent.runtime.agent.AgentContext;
import com.linrun.reactor.domain.agent.runtime.dto.tool.McpToolInfo;
import com.linrun.reactor.domain.agent.runtime.tool.ToolCollection;
import com.linrun.reactor.domain.agent.runtime.tool.common.CodeInterpreterTool;
import com.linrun.reactor.domain.agent.runtime.tool.common.DataAnalysisTool;
import com.linrun.reactor.domain.agent.runtime.tool.common.DeepSearchTool;
import com.linrun.reactor.domain.agent.runtime.tool.common.FileTool;
import com.linrun.reactor.domain.agent.runtime.tool.common.ImageGenerationTool;
import com.linrun.reactor.domain.agent.runtime.tool.common.MultiModalAgent;
import com.linrun.reactor.domain.agent.runtime.tool.common.ReportTool;
import com.linrun.reactor.domain.agent.runtime.tool.common.WebFetchTool;
import com.linrun.reactor.domain.agent.runtime.tool.common.skill.GlobTool;
import com.linrun.reactor.domain.agent.runtime.tool.common.skill.GrepTool;
import com.linrun.reactor.domain.agent.runtime.tool.common.skill.ListDirectoryTool;
import com.linrun.reactor.domain.agent.runtime.tool.common.skill.ReadTool;
import com.linrun.reactor.domain.agent.runtime.tool.common.skill.ScriptRunnerTool;
import com.linrun.reactor.domain.agent.runtime.tool.common.skill.SkillTool;
import com.linrun.reactor.domain.agent.runtime.tool.mcp.runtime.McpToolExecutor;
import com.linrun.reactor.domain.agent.runtime.tool.skill.SkillRegistry;
import com.linrun.reactor.domain.agent.runtime.tool.skill.SkillRuntimeOptions;
import com.linrun.reactor.domain.agent.runtime.tool.skill.SkillScriptRunnerClient;
