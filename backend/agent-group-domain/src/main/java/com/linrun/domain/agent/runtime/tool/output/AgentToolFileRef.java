...
public class AgentToolFileRef {
    ...
    private AgentToolFileRef(Builder builder) {
    ...
    public static AgentToolFileRef fromMap(Map<String, Object> map) {
    ...
    public static final class Builder {
        ...
        public AgentToolFileRef build() {
            return new AgentToolFileRef(this);
        }
    }
}
