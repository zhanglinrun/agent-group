...
public final class AgentToolOutputProjector {

    private AgentToolOutputProjector() {
    }

    public static Map<String, Object> toResultMap(AgentToolStructuredOutput output) {
        if (output == null) {
            return Map.of();
        }
    ...
    public static AgentToolCallResult toCallResult(AgentToolStructuredOutput output,
                                                      String action,
                                                      long latencyMillis) {
    ...
    public static String summarize(AgentToolStructuredOutput output) {
        if (output == null) {
            return "";
        }
